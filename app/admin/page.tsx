        ...
        <div className="flex flex-wrap items-center gap-2">
          {contacts.length > 0 ? (
            <form action="/api/admin/contacts" method="POST">
              ...
              <button
                type="submit"
                className="rounded-full border border-rose-200 px-4 py-2 text-xs font-medium text-rose-700 hover:border-rose-300 hover:text-rose-800"
              >
                Vaciar
              </button>
            </form>
              ...
              <article key={contact.id} className="px-4 py-5">
                <div className="flex flex-wrap items-center gap-2 text-sm">
                  ...
                  <form action="/api/admin/contacts" method="POST">
                    ...
                    <button
                      type="submit"
                      className="rounded-full border border-black/10 px-3 py-1 text-[10px] font-medium text-[var(--muted)] hover:text-[var(--ink)]"
                    >
                      Borrar
                    </button>
                  </form>
